...
var FeedbackRepositories = require('/Users/oseli/Desktop/캡스톤 2/코드/finalcap2/server/repositories/FeedbackRepositories.js');
var pool = require('/Users/oseli/Desktop/캡스톤 2/코드/finalcap2/server/pgConnect.js'); // PostgreSQL 연결


// services/FeedbackService.js
var { spawn } = require('child_process');
var { getLatestInput, savePredictionResult } = require('../repositories/FeedbackRepositories.js');  // 경로 수정
var pool = require('/Users/oseli/Desktop/캡스톤 2/코드/finalcap2/server/pgConnect.js'); // PostgreSQL 연결
