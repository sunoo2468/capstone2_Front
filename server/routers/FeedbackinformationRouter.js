...
const FeedbackinformationRepository = require('/Users/oseli/Desktop/캡스톤 2/코드/finalcap2/server/repositories/FeedbackinformationRepository.js');
const FeedbackcommnetController = express.Router();

// 사용자 로그인 처리
FeedbackcommnetController.post('/feedback', async (req, res) => {
...
module.exports = FeedbackcommnetController;
